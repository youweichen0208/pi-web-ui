...
```bash
# ── 安装 ──
pi-web-ui install https://github.com/youweichen0208/pi-web-ui/tree/develop/dev/plugins/webmail
...
# ── 更新 ──
pi-web-ui install https://github.com/youweichen0208/pi-web-ui/tree/develop/dev/plugins/webmail --force
                                             # --force 覆盖重装即更新
